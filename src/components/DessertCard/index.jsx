      ...
      <div className="relative mb-8">
        <img
          className={`rounded-xl ${
            isProductInCart(name) ? "border-2 border-orange_red" : null
          } w-64 h-64`}
          src={image}
          alt={name}
        />
        {isProductInCart(name) ? (
          <div className="flex items-center justify-between w-44 absolute left-10 -bottom-6 py-3 px-7 bg-orange_red rounded-full border border-orange_red font-semibold gap-2 text-white">
            <FaMinus
              ...
              className="text-xl hover:bg-white cursor-pointer rounded-full hover:text-orange_red p-1 border"
            />
          ...
          <button
            className="flex w-44 absolute left-10 -bottom-6 py-3 px-7 bg-white rounded-full border border-dark_rose font-semibold gap-2 text-very_dark_rose hover:text-orange_red hover:border-orange_red transition"
