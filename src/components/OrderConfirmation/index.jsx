  ...
  const CartItemsElements = cartItems.map((item) => (
    <div className="flex items-center border-b-[1px] py-4" key={nanoid()}>
      ...
      <div className="mr-auto">
        <h2 className="text-very_dark_rose font-semibold text-sm">
          {item.name}
        </h2>
        <div className="flex">
          <h3 className="text-orange_red font-semibold text-sm mr-2">
            {item.quantity}x
          </h3>
          <h3 className="text-rose font-medium text-sm mr-4">
            ${item.price.toFixed(2)}
          </h3>
        </div>
      </div>
      <span className="text-very_dark_rose font-semibold">
  ...
  return (
    <div className="bg-white w-[450px] p-8 rounded-xl sm:w-screen sm:rounded-b-none">
      <img
        ...
        alt="order confirmed"
      />
      <h2 className="text-very_dark_rose text-4xl font-bold mb-2">
        Order Confirmed
      </h2>
      ...
      <div className="bg-very_light_rose rounded p-4 mb-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-xl text-very_dark_rose font-bold">
      ...
      <button
        ...
        className="bg-orange_red text-white w-full p-3 rounded-full hover:brightness-75 transition"
      >
        Start New Order
      </button>
    </div>
